...
class testApiResourceIdentifier(testCase):
    ...
    def test_set_relationship(self):
        ...
        resource.relationship(
            "messages",
            [
                create_resource({"type": "message", "id": "messageOne"}),
                create_resource({"type": "message", "id": "messageTwo"}),
            ],
        )
    ...
    def test_get_json_relationships(self):
        ...
        resource.relationship(
            "resource_identifier", ApiResourceIdentifier("this", "that")
        )
    ...
    def test_get_json_changed_relationships(self):
        ...
        self.assertEqual(
            resource.get_json_changed_relationships(),
            {"messages": {"data": {"id": "that", "type": "this"}}},
        )
            ...
            json.dumps(
                {
                    ...
                    "id": "FakeID",
                    "relationships": {
                        "thing": {"data": {"type": "things", "id": "thingID"}}
                    },
                }
            ),
        )
